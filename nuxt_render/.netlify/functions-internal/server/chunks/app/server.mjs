import { hasInjectionContext, getCurrentInstance, inject, version, useSSRContext, ref, watchEffect, watch, defineComponent, computed, h, resolveComponent, mergeProps, withCtx, createTextVNode, createApp, reactive, unref, Suspense, nextTick, Transition, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, shallowReactive, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-6c2cf8e0.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-bfe83c4c.mjs').then((m) => m.default || m)
  },
  {
    name: "posts-id",
    path: "/posts/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-52e59e69.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))}><nav><ul><li>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-a790ffaa.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-14fa7db7.mjs').then((r) => r.default || r));
...
export { __nuxt_component_0 as _, useRoute as a, useNuxtApp as b, createError as c, entry$1 as default, useHead as u };
