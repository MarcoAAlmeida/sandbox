...
const _lazy_fEIB1y = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_fEIB1y, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_fEIB1y, lazy: true, middleware: false, method: undefined }
];
