globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join as join$1 } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, getQuery, getCookie, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/hookable/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/radix3/dist/index.mjs';
import { extname, join } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/pathe/dist/index.mjs';
import { unified } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/unified/index.js';
import { toString } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/mdast-util-to-string/index.js';
import { preprocess } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/micromark/dev/lib/postprocess.js';
import { stringifyPosition } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/micromark-util-resolve-all/index.js';
import remarkEmoji from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/remark-emoji/index.js';
import rehypeSlug from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/rehype-slug/index.js';
import remarkSqueezeParagraphs from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/remark-squeeze-paragraphs/index.js';
import rehypeExternalLinks from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/rehype-external-links/index.js';
import remarkGfm from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/remark-gfm/index.js';
import rehypeSortAttributeValues from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/rehype-raw/index.js';
import remarkMDC, { parseFrontMatter } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/remark-mdc/dist/index.mjs';
import remarkParse from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/remark-parse/index.js';
import remark2rehype from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/remark-rehype/index.js';
import { all } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/mdast-util-to-hast/index.js';
import { detab } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/detab/index.js';
import { u } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/unist-builder/index.js';
import { encode } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/mdurl/index.js';
import slugify from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/slugify/slugify.js';
import { position } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/unist-util-position/index.js';
import { visit } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/unist-util-visit/index.js';
import { BUNDLED_LANGUAGES, BUNDLED_THEMES, getHighlighter } from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/shiki-es/dist/shiki.node.mjs';
import consola from 'file://C:/Users/marco/pub/sandbox/mlearn/node_modules/unenv/runtime/npm/consola.mjs';
...
const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{"content":{"locales":[],"defaultLocale":"","integrity":"","experimental":{"stripQueryParameters":false,"clientDB":false},"api":{"baseURL":"/api/_content"},"navigation":{"fields":["layout"]},"tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"highlight":{"theme":{"default":"min-dark","dark":"min-dark","sepia":"one-dark-pro"},"preload":["javascript","java","python"]},"wsUrl":"ws://localhost:4000/","documentDriven":{"page":true,"navigation":true,"surround":true,"globals":{},"layoutFallbacks":["theme"],"injectPage":true},"host":"","trailingSlash":false,"anchorLinks":{"depth":2,"exclude":[1]}}},"content":{"cacheVersion":2,"cacheIntegrity":"TIWoLn3Tiu","transformers":[],"base":"","api":{"baseURL":"/api/_content"},"watch":{"ws":{"port":{"port":4000,"portRange":[4000,4040]},"hostname":"localhost","showURL":false}},"sources":{},"ignores":["\\.","-"],"locales":[],"defaultLocale":"","highlight":{"theme":{"default":"min-dark","dark":"min-dark","sepia":"one-dark-pro"},"preload":["javascript","java","python"]},"markdown":{"tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"anchorLinks":{"depth":2,"exclude":[1]},"remarkPlugins":{},"rehypePlugins":{}},"yaml":{},"csv":{"delimeter":",","json":true},"navigation":{"fields":["layout"]},"documentDriven":true,"experimental":{"clientDB":false,"stripQueryParameters":false}},"pinceau":{"studio":false,"outputDir":"C:/Users/marco/pub/sandbox/mlearn/.nuxt/pinceau/"},"appConfigSchema":{"properties":{"id":"#appConfig","properties":{"prose":{"title":"Prose configuration from Nuxt Typography","description":"","tags":["@studio-icon material-symbols:short-text-rounded"],"id":"#appConfig/prose","properties":{"copyButton":{"title":"Copy button (used in code blocks)","description":"","tags":["@studio-icon material-symbols:content-copy"],"id":"#appConfig/prose/copyButton","properties":{"iconCopy":{"title":"Icon displayed to copy","description":"","tags":[],"id":"#appConfig/prose/copyButton/iconCopy","default":"ph:copy","type":"string"},"iconCopied":{"title":"Icon displayed when copied","description":"","tags":[],"id":"#appConfig/prose/copyButton/iconCopied","default":"ph:check","type":"string"}},"default":{"iconCopy":"ph:copy","iconCopied":"ph:check"},"type":"object"},"headings":{"title":"Default configuration for all headings (h1, h2, h3, h4, h5 and h6)","description":"","tags":["@studio-icon material-symbols:title"],"id":"#appConfig/prose/headings","properties":{"icon":{"title":"Default icon for anchor link on hover","description":"","tags":[],"tsType":"string|false","id":"#appConfig/prose/headings/icon","default":"ph:link","type":"string"}},"default":{"icon":"ph:link"},"type":"object"},"h1":{"title":"First heading configuration","description":"","tags":["@studio-icon material-symbols:format-h1"],"id":"#appConfig/prose/h1","properties":{"icon":{"title":"Icon displayed for anchor link on hover","description":"","tags":[],"tsType":"string|false","id":"#appConfig/prose/h1/icon","default":"","type":"string"}},"default":{"icon":""},"type":"object"},"h2":{"title":"Second heading configuration","description":"","tags":["@studio-icon material-symbols:format-h2"],"id":"#appConfig/prose/h2","properties":{"icon":{"title":"Icon displayed for anchor link on hover","description":"","tags":[],"tsType":"string|false","id":"#appConfig/prose/h2/icon","default":"","type":"string"}},"default":{"icon":""},"type":"object"},"h3":{"title":"Third heading configuration","description":"","tags":["@studio-icon material-symbols:format-h3"],"id":"#appConfig/prose/h3","properties":{"icon":{"title":"Icon displayed for anchor link on hover","description":"","tags":[],"tsType":"string|false","id":"#appConfig/prose/h3/icon","default":"","type":"string"}},"default":{"icon":""},"type":"object"},"h4":{"title":"Fourth heading configuration","description":"","tags":["@studio-icon material-symbols:format-h4"],"id":"#appConfig/prose/h4","properties":{"icon":{"title":"Icon displayed for anchor link on hover","description":"","tags":[],"tsType":"string|false","id":"#appConfig/prose/h4/icon","default":"","type":"string"}},"default":{"icon":""},"type":"object"},"h5":{"title":"Fifth heading configuration","description":"","tags":["@studio-icon material-symbols:format-h5"],"id":"#appConfig/prose/h5","properties":{"icon":{"title":"Icon displayed for anchor link on hover","description":"","tags":[],"tsType":"string|false","id":"#appConfig/prose/h5/icon","default":"","type":"string"}},"default":{"icon":""},"type":"object"},"h6":{"title":"Sixth heading configuration","description":"","tags":["@studio-icon material-symbols:format-h6"],"id":"#appConfig/prose/h6","properties":{"icon":{"title":"Icon displayed for anchor link on hover","description":"","tags":[],"tsType":"string|false","id":"#appConfig/prose/h6/icon","default":"","type":"string"}},"default":{"icon":""},"type":"object"}},"default":{"copyButton":{"iconCopy":"ph:copy","iconCopied":"ph:check"},"headings":{"icon":"ph:link"},"h1":{"icon":""},"h2":{"icon":""},"h3":{"icon":""},"h4":{"icon":""},"h5":{"icon":""},"h6":{"icon":""}},"type":"object"},"cover":{"type":"string","id":"#appConfig/cover","default":"/cover.jpg"},"socials":{"id":"#appConfig/socials","properties":{"github":{"type":"string","id":"#appConfig/socials/github","default":""}},"default":{"github":""},"type":"object"}},"default":{"cover":"/cover.jpg","socials":{"github":""},"prose":{"copyButton":{"iconCopy":"ph:copy","iconCopied":"ph:check"},"headings":{"icon":"ph:link"},"h1":{"icon":""},"h2":{"icon":""},"h3":{"icon":""},"h4":{"icon":""},"h5":{"icon":""},"h6":{"icon":""}}},"type":"object"},"default":{"cover":"/cover.jpg","socials":{"github":""},"prose":{"copyButton":{"iconCopy":"ph:copy","iconCopied":"ph:check"},"headings":{"icon":"ph:link"},"h1":{"icon":""},"h2":{"icon":""},"h3":{"icon":""},"h4":{"icon":""},"h5":{"icon":""},"h6":{"icon":""}}}}};
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/marco/pub/sandbox/mlearn/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"C:\\Users\\marco\\pub\\sandbox\\mlearn\\content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\marco\\pub\\sandbox\\mlearn\\.nuxt\\content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('pinceau', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\marco\\pub\\sandbox\\mlearn\\.nuxt\\pinceau\\theme","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\marco\\pub\\sandbox\\mlearn","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\marco\\pub\\sandbox\\mlearn\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\marco\\pub\\sandbox\\mlearn\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\marco\\pub\\sandbox\\mlearn\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const script = "\"use strict\";const w=window,de=document.documentElement,knownColorSchemes=[\"dark\",\"light\"],preference=window.localStorage.getItem(\"nuxt-color-mode\")||\"light\";let value=preference===\"system\"?getColorScheme():preference;const forcedColorMode=de.getAttribute(\"data-color-mode-forced\");forcedColorMode&&(value=forcedColorMode),addColorScheme(value),w[\"__NUXT_COLOR_MODE__\"]={preference,value,getColorScheme,addColorScheme,removeColorScheme};function addColorScheme(e){const o=\"\"+e+\"\",t=\"\";de.classList?de.classList.add(o):de.className+=\" \"+o,t&&de.setAttribute(\"data-\"+t,e)}function removeColorScheme(e){const o=\"\"+e+\"\",t=\"\";de.classList?de.classList.remove(o):de.className=de.className.replace(new RegExp(o,\"g\"),\"\"),t&&de.removeAttribute(\"data-\"+t)}function prefersColorScheme(e){return w.matchMedia(\"(prefers-color-scheme\"+e+\")\")}function getColorScheme(){if(w.matchMedia&&prefersColorScheme(\"\").media!==\"not all\"){for(const e of knownColorSchemes)if(prefersColorScheme(\":\"+e).matches)return e}return\"light\"}\n";

const _JgF6Olq2Kg = (function(nitro) {
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file://C:/Users/marco/pub/sandbox/mlearn/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _djwoyA = defineEventHandler(async (event) => {
...
const _IfOw6a = defineEventHandler(async (event) => {
...
const _XvqISW = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_p7RY8b = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_p7RY8b, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _djwoyA, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _djwoyA, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _djwoyA, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _IfOw6a, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _XvqISW, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _XvqISW, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _XvqISW, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_p7RY8b, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/marco/pub/sandbox/mlearn/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://C:/Users/marco/pub/sandbox/mlearn/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
